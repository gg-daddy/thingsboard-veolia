...
public class ZONGJob extends Job {
    ...
    public void processingTasks() throws Exception {
        System.out.println("定时任务开始... 混合的");
        List<DeviceEntity> all = new LinkedList<>();
...
//        all.addAll(deviceRepository.findByTenantIdAndType("1eab9e802ba5aa092284b8ee4a402d9","速耐连七合一"));
        //市政院2号楼
        all.addAll(deviceRepository.findByTenantIdAndType("1eb14336092c090a0fa793db9637587","kaiterra"));
            ...
            while (flag) {
                ...
                List<TsKvCfEntity> list1 = tsKvServer.findAll1(deviceEntity.getId(), DateUtils.getBeginDayOfYesterday(), DateUtils.getEndDayOfYesterDay(), "11");
                    ...
                    for (TsKvHourHistoryEntity thh : entityList) {
                        thh.setEntityId(deviceEntity.getId().toString());
                        tsKvServer.add(thh);
                    }
    ...
    public static void main(String[] args) {
        ...
        UUID uuid = UUIDConverter.fromString("1eb3918b30eebf08f9d89096cf31278");
